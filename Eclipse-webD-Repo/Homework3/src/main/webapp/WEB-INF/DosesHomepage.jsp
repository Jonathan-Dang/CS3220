...
<p>
	<a href="NewVaccine" class="btn btn-primary m-2">New Vaccine</a>
	<a href="NewDoses" class="btn btn-primary m-2">New Doses</a>
	<a href="HospitalManagement" class="btn btn-primary m-2">Back to Homepage</a>
</p>
...
<table class="table table-hover">
	...
	<c:forEach items ="${ entries }" var="entry">
		<tr>
			...
			<td><a href="EditVaccine?id=${ entry.getId() }" class="btn btn-outline-primary">Edit</a></td>
		</tr>
	</c:forEach>
